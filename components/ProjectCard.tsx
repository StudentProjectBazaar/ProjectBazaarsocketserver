...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden group transition-all duration-300 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-600/10:shadow-blue-500/20">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <button onClick={() => navigateTo('auth')} className="bg-gray-200 text-gray-800 font-semibold py-2 px-4 rounded-lg hover:bg-gradient-to-r from-blue-500 to-purple-600 hover:text-white transition-all duration-300">
            View Details
          </button>
        </div>
      </div>
