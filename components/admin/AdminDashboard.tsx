...
export type AdminView = 'project-management' | 'fraud-management' | 'user-management' | 'revenue-analytics' | 'payout-systems' | 'courses' | 'user-profile' | 'admin-project-details' | 'admin-report-details';
