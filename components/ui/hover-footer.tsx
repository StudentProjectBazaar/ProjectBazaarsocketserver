  ...
  return (
    ...
    >
      ...
      <motion.text
        ...
        dominantBaseline="middle"
        strokeWidth="0.3"
        className="fill-transparent stroke-orange-500 font-[helvetica] text-5xl font-bold dark:stroke-orange-500/60"
...
export const FooterBackgroundGradient = () => {
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(125% 125% at 50% 10%, #000000 50%, #f9731622 100%)",
      }}
    />
  );
};
