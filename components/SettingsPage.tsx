                                        ...
                                        <div className="space-y-3 max-h-96 overflow-y-auto">
                                            {repositories.map((repo) => (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        onClick={() => uploadToProjectBazaar(repo.html_url, repo.name)}
                                                        className="ml-4 px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg hover:from-orange-600 hover:to-orange-700 transition-all shadow-sm hover:shadow-md flex-shrink-0"
                                                    >
